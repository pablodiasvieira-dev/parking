import { BotaoTipoInicial } from "./button";

export function ModalDownUp(){
    return (
        <> 
            <div className=" bottom-24 left-0 z-40 flex flex-col w-full h-20 bg-white gap-1 rounded-t-2xl shadow-[0px_-10px_10px_-1px_rgba(0,_0,_0,_0.45)]">
